...
switch (deviceType) {
    case "DF701":
        result = Parse_Code_DF701(payloadJson, metadata);
        break;
...
function Parse_Code_DF701(payload_in, metadata_in) {
    var height = 0;
    var temperature = 0;
    var angle = 0;
    var full_alarm = 0;
    ...
    if (
        (incomingHexData.length != 36 && incomingHexData
            .length != 24) ||
        incomingHexData.substring(0, 6) != "800001" ||
    ...
    if (
        ...
        incomingHexData.substring(8, 10) == "0C" &&
        ...
        var result = {
            ...
            attributes: {
                ...
                levelThreshold: parseInt(incomingHexData
                    .substring(18, 20), 16),
                //fireThreshold: parseInt(incomingHexData.substring(20, 22), 16),
