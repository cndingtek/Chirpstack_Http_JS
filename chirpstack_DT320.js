...
switch (deviceType) {
    case "DT320":
        result = Parse_Code_DT320(payloadJson, metadata);
        break;
...
function Parse_Code_DT320(payload_in, metadata_in) {
    ...
    //0x01/02 packet
    if (
        (incomingHexData.substring(0, 10) == "8000200212" ||
            incomingHexData.substring(0, 10) == "8000200112"
        ) &&
        ...
        incomingHexData.substring(0, 8) == "80002003" &&
