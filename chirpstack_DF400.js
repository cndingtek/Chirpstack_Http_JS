...
switch (deviceType) {
    case "DF400":
        result = Parse_Code_DF400(payloadJson, metadata);
        break;
...
//For tissue  sensor DF400
function Parse_Code_DF400(payload_in, metadata_in) {
    var height = 0;
    var temperature = 0;
    var angle = 0;
    var full_alarm = 0;
