...
switch (deviceType) {
    case "DM500":
        result = Parse_Code_DM500(payloadJson, metadata);
        break;
...
function Parse_Code_DM500(payload_in, metadata_in) {
    ...
    if (
        ...
        incomingHexData.substring(8, 10) == "0D"
    ) {
        var result = {
            ...
            telemetry: {
                density: parseInt(incomingHexData
                    .substring(10, 14), 16),
                temperature: parseInt(incomingHexData
                    .substring(14, 16), 16),
                alarmTemperature: parseInt(
        ...
        var result = {
            ...
            attributes: {
                ...
                uploadInterval: parseInt(incomingHexData
                    .substring(14, 16), 16),
                liquidType: parseInt(incomingHexData
                    .substring(16, 18), 16),
                referenceSpeed: parseInt(incomingHexData
                    .substring(18, 22), 16),
                referenceDensity: parseInt(
                    incomingHexData.substring(22,
                        26), 16),
                temperatureThreshold: parseInt(
