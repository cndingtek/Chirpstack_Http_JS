...
switch (deviceType) {
    case "DT322":
        result = Parse_Code_DT322(payloadJson, metadata);
        break;
...
function Parse_Code_DT322(payload_in, metadata_in) {

    var incomingHexData = base64ToHex(payload_in.data);
    //0x01/02 packet
    if (
        (incomingHexData.substring(0, 10) == "8000220212" ||
            incomingHexData.substring(0, 10) == "8000220112"
        ) &&
        ...
        var re = {
            ...
            telemetry: {
                ...
                alarmHighTemperature: parseInt(
                        incomingHexData
                        .substring(18, 19), 16) > 0 ?
                    true : false,
                alarmLowTemperature: parseInt(
                        incomingHexData
                        .substring(19, 20), 16) > 0 ?
                    true : false,
                alarmHighHumidity: parseInt(
                        incomingHexData
                        .substring(20, 21), 16) > 0 ?
                    true : false,
                alarmLowHumidity: parseInt(
                        incomingHexData
                        .substring(21, 22), 16) > 0 ?
                    true : false,
        ...
        incomingHexData.substring(0, 8) == "80002203" &&
        incomingHexData.length == 38
    ) {
        //0x03 packet
        ...
        var re = {
            ...
            attributes: {
                ...
                highTemperatureThreshold: high_temp >
                    127 ? high_temp - 256 : high_temp,
                lowTemperatureThreshold: low_temp >
                    127 ? low_temp - 256 : low_temp,
                ...
                lowHumidityThreshold: parseInt(
                    incomingHexData.substring(28,
                        30), 16),
                referenceResistance: parseInt(
                    incomingHexData.substring(30,
                        34), 16) * 10,
