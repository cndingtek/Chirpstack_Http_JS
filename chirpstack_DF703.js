...
switch (deviceType) {
    case "DF703":
    case "DF702":
        result = Parse_Code_DF703(payloadJson, metadata);
        break;
...
return result;
//For waste bin sensor DF703

function Parse_Code_DF703(payload_in, metadata_in) {
    var height = 0;
    var temperature = 0;
    var angle = 0;
    var full_alarm = 0;
        ...
        var result = {
            ...
            telemetry: {
                ...
                alarmBattery: out_battery_al ? true :
                    false,
                alarmFire: out_fire_al ? true : false,
